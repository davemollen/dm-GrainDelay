...
- Open the terminal and run "scp -rp <path-to-plugin.lv2> root@moddwarf.local:/root/.lv2/" to copy the lv2 folder to your MOD. 
Don't forget to replace <path-to-plugin.lv2> with the correct path. 
On macOS you might need to use "scp -O -rp ...." instead.
- If this is the first time you connect to your MOD via ssh you might get the following prompt: 
